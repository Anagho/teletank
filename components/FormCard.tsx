    ...
    <LinearGradient colors={colors.gradients.surface}
      ...
      {selectedTank.type === "rectangular" && (
        <>
          ...
          <TextInput style={formStyles.input} value={rectLength} onChangeText={setRectLength} keyboardType="numeric" />
          <Text style={formStyles.label}>Width (cm)</Text>
          <TextInput style={formStyles.input} value={width} onChangeText={setWidth} keyboardType="numeric" />
          <Text style={formStyles.label}>Height (cm)</Text>
          <TextInput style={formStyles.input} value={height} onChangeText={setHeight} keyboardType="numeric" />
        </>
      )}

      {selectedTank.type === "cylindrical" && selectedTank.orientation === "horizontal" && (
        <>
          <Text style={formStyles.label}>Length (cm)</Text>
          <TextInput style={formStyles.input} value={length} onChangeText={setLength} keyboardType="numeric" />
          <Text style={formStyles.label}>Diameter (cm)</Text>
          <TextInput style={formStyles.input} value={diameter} onChangeText={setDiameter} keyboardType="numeric" />
        </>
      )}

      {selectedTank.type === "cylindrical" && selectedTank.orientation === "vertical" && (
        <>
          <Text style={formStyles.label}>Diameter (cm)</Text>
          <TextInput style={formStyles.input} value={diameter} onChangeText={setDiameter} keyboardType="numeric" />
          <Text style={formStyles.label}>Height (cm)</Text>
